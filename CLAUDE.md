...
- **Test the app after your task is done.** Tests and lint aren't enough — launch the app with `npm start` and try the feature you changed before calling it done. If you can't run it, say so.
