...
export default {
  ...
  strings: {
    ...
    'setup.intro': "This IDE runs the Claude Code CLI, which isn't installed yet. Install it to start a session.",
    'setup.detected': 'Detected platform: {os}',
    'setup.step.install': 'Install',
    'setup.step.signin': 'Sign in',
    'setup.step.done': 'Done',
    'setup.recommended': 'Recommended install',
    'setup.viaNpm': 'Or install with npm (needs Node.js 18+)',
    'setup.copy': 'Copy',
    'setup.copied': 'Copied',
    'setup.runInTerminal': 'Run in terminal',
    'setup.installHint': 'Click “Run in terminal” to install right here, or copy a command into your own terminal and click Next.',
    'setup.signinInfo': 'When the install finishes, Claude Code starts its login automatically in the terminal below. Follow the prompts — a browser window opens, or paste the code it shows.',
    'setup.signinManual': 'Installed it in your own terminal? Run “claude” there to sign in.',
    'setup.doneInfo': 'Once Claude Code is installed and you’re signed in, recheck to finish setup.',
    ...
    'setup.recheck': "I've installed it — Recheck",
