...
export default {
  ...
  strings: {
    ...
    'setup.step.installing': 'Installing',
    'setup.step.signin': 'Sign in',
    'setup.intro': "This IDE runs the Claude Code CLI, but it isn't installed yet.",
    'setup.introNext': 'Click Next and the IDE will install it for you.',
    'setup.detected': 'Detected platform: {os}',
    'setup.installing': 'Please wait while Claude Code installs…',
    'setup.installDone': 'Installation complete. Click Next to sign in.',
    'setup.installFailed': 'The installer reported an error — check the output above.',
    'setup.authText': 'Please continue signing in using the terminal below.',
    'setup.authWaiting': 'Waiting for sign-in to complete…',
    'setup.authDone': 'Signed in. Click Finish.',
    'setup.next': 'Next',
    'setup.back': 'Back',
    'setup.finish': 'Finish',
