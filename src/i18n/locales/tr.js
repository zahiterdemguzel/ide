...
export default {
  ...
  strings: {
    ...
    'settings.customModelsHint': 'Ollama ile açık kaynak modelleri kurun ve oturumlarda kullanın.',
    'settings.customModels.setup': 'Ollama’yı kur',
    'settings.customModels.settingUp': 'Kuruluyor…',
    'settings.customModels.unavailable': 'Ollama motoru bu sürümde kullanılamıyor.',
    ...
    'settings.customModels.removeAll': 'Tüm Ollama verilerini sil',
