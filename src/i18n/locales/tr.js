...
export default {
  ...
  strings: {
    ...
    'setup.step.installing': 'Kuruluyor',
    'setup.step.signin': 'Giriş yap',
    'setup.intro': 'Bu IDE, Claude Code CLI ile çalışır, ancak henüz kurulu değil.',
    'setup.introNext': 'Sonraki’ye tıklayın; IDE onu sizin için kuracak.',
    'setup.detected': 'Algılanan platform: {os}',
    'setup.installing': 'Claude Code kurulurken lütfen bekleyin…',
    'setup.installDone': 'Kurulum tamamlandı. Giriş yapmak için Sonraki’ye tıklayın.',
    'setup.installFailed': 'Kurulum bir hata bildirdi — yukarıdaki çıktıyı kontrol edin.',
    'setup.authText': 'Lütfen aşağıdaki terminali kullanarak girişe devam edin.',
    'setup.authWaiting': 'Girişin tamamlanması bekleniyor…',
    'setup.authDone': 'Giriş yapıldı. Bitir’e tıklayın.',
    'setup.next': 'Sonraki',
    'setup.back': 'Geri',
    'setup.finish': 'Bitir',
