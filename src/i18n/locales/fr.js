...
export default {
  ...
  strings: {
    ...
    'setup.intro': "Cet IDE utilise la CLI Claude Code, mais elle n'est pas encore installée.",
    'setup.introNext': 'Cliquez sur Suivant et l’IDE l’installera pour vous.',
    'setup.detected': 'Plateforme détectée : {os}',
    'setup.installing': 'Veuillez patienter pendant l’installation de Claude Code…',
    'setup.installDone': 'Installation terminée. Cliquez sur Suivant pour vous connecter.',
    'setup.installFailed': 'L’installateur a signalé une erreur — vérifiez la sortie ci-dessus.',
    'setup.authText': 'Veuillez poursuivre la connexion dans le terminal ci-dessous.',
    'setup.authWaiting': 'En attente de la fin de la connexion…',
    'setup.authDone': 'Connecté. Cliquez sur Terminer.',
    'setup.next': 'Suivant',
    'setup.back': 'Retour',
