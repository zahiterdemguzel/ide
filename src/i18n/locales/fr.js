...
export default {
  ...
  strings: {
    ...
    'setup.intro': "Cet IDE utilise la CLI Claude Code, qui n'est pas encore installée. Installez-la pour démarrer une session.",
    'setup.detected': 'Plateforme détectée : {os}',
    'setup.step.install': 'Installer',
    'setup.step.signin': 'Se connecter',
    'setup.step.done': 'Terminé',
    'setup.recommended': 'Installation recommandée',
    'setup.viaNpm': 'Ou installez-la avec npm (nécessite Node.js 18+)',
    'setup.copy': 'Copier',
    'setup.copied': 'Copié',
    'setup.runInTerminal': 'Exécuter dans le terminal',
    'setup.installHint': 'Cliquez sur « Exécuter dans le terminal » pour installer ici, ou copiez une commande dans votre propre terminal puis cliquez sur Suivant.',
    'setup.signinInfo': 'Une fois l’installation terminée, Claude Code lance automatiquement la connexion dans le terminal ci-dessous. Suivez les instructions — une fenêtre du navigateur s’ouvre, ou collez le code affiché.',
    'setup.signinManual': 'Installée dans votre propre terminal ? Exécutez-y « claude » pour vous connecter.',
    'setup.doneInfo': 'Une fois Claude Code installé et connecté, revérifiez pour terminer la configuration.',
    ...
    'setup.recheck': 'Je l’ai installée — Revérifier',
