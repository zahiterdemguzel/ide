...
export default {
  ...
  strings: {
    ...
    'setup.installHint': 'Klicke auf „Im Terminal ausführen“, um hier zu installieren, oder kopiere einen Befehl in dein eigenes Terminal und klicke auf Weiter.',
    'setup.signinInfo': 'Wenn die Installation fertig ist, startet Claude Code die Anmeldung automatisch im Terminal unten. Folge den Anweisungen — ein Browserfenster öffnet sich, oder füge den angezeigten Code ein.',
    'setup.signinManual': 'In deinem eigenen Terminal installiert? Führe dort „claude“ aus, um dich anzumelden.',
    'setup.doneInfo': 'Sobald Claude Code installiert und du angemeldet bist, prüfe erneut, um die Einrichtung abzuschließen.',
