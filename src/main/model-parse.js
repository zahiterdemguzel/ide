...
// the badge's own dropdown). The line-buffer bookkeeping lives in the shared
// slash-parse.js; this only layers the command match on top, and it stays
// unit-tested (test/model-parse.test.js).
//
